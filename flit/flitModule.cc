...
/*
 * Adds hop to flit counter when advancing from a switch
...
/*
 * Adds cycle to contention counter when a flit is received
 * in a switch. Distinguishes between normal and escape
 * subnetwork counters.
 */
